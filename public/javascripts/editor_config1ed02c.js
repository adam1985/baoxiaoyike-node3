...
(function () {
    ...
    //var LANG = (function(){var u = location.search.match(/lang=([^&$]+)/); return u ? u[1] : (/wechat/.test(location.host) ? 'en_US' : 'zh_CN')})();
    //var TOKEN = (function(){var u = location.search.match(/token=([^&$]+)/); return u ? u[1] : ''})();
    var LANG = window.wx.data.lang;
    var TOKEN = window.wx.data.t;
    /**
     ...
     */
    var URL = window.UEDITOR_HOME_URL = "/mpres/htmledition/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:'/cgi-bin/uploadimg2cdn?t=ajax-editor-upload-img&lang=' + LANG + '&token=' + TOKEN             //图片上传提交地址
        ...
        , toolbars:[["bold","italic","underline","|","insertorderedlist","insertunorderedlist","|","insertimage","|",'removeformat','forecolor','backcolor',"insertvideo","insertvote","insertcard", "source", "link"]]
        /*[
